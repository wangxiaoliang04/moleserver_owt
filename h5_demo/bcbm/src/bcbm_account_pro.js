...
var m_myselfUserRoomId = -1;
var m_myselfUserChairIndex = -1;
...
var CRegisterLayer = cc.LayerColor.extend({
    ...
    init: function () {
        ...
        this.sprite = new cc.Sprite(v_sprite_login_bg);
        ...
        var RegisterBtnItem = new cc.MenuItemImage.create(
            v_sprite_login_register_1,
            v_sprite_login_register_2,
            function () {
...
var CLoginLayer = cc.LayerColor.extend({
    ...
    init: function () {
        ...
        var LoginBtnItem = new cc.MenuItemImage.create(
            v_sprite_login_login_1,
            v_sprite_login_login_2,
            function () {
                if(this._boxusername.getString() == "")
                {
                    var msglayer = new MessageBoxLayer();
    ...
    switch(obj.MsgId) {
        ...
        case 800: {
            ...
            if (MsgSubId == 803) {
                ...
                var m_gameserver = "ws://" + obj.Room[3].serverip + ":" + obj.Room[3].serverport;
